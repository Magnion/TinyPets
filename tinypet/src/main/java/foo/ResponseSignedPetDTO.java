...
public class ResponseSignedPetDTO  {
    private Long id;
    ...
    public ResponseSignedPetDTO(Long id, String namePetition, String description, long nbsignataires, String pseudo, String formattedDate,List<String> tags) {
        this.id = id;
